    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form ubah data Achievement Kojima</h5>

                        <!-- General Form Elements -->
                        <?= form_open_multipart('achievement/editachieve/' . $ach['id_ach']); ?>
                            ...
                            <div class="col-sm-9">
                                <select name="tahun" id="tahun" class="form-select <?= form_error('tahun') ? 'is-invalid' : '' ?>">
                                    ...
                                    <?php foreach ($tahun_list as $th) : ?>
                                        <option value="<?= $th ?>" <?= $ach['tahun'] == $th ? 'selected' : '' ?>><?= $th ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="nama_ach" type="text" class="form-control <?= form_error('nama_ach') ? 'is-invalid' : '' ?>" value="<?= $ach['nama_ach']; ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea name="deskripsi" class="form-control <?= form_error('deskripsi') ? 'is-invalid' : '' ?>" rows="5"><?= $ach['deskripsi']; ?></textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4 text-center">
                                <img src="<?= base_url('assets/vendor/landingpage/image/achievement/') . $ach['dokumen']; ?>" alt="Logo Achievement" class="img-thumbnail" style="width: 100px; height: 150px;">
                            </div>
                            <div class="col-sm-5">

                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input name="submenunav" type="text" class="form-control <?= form_error('submenunav') ? 'is-invalid' : '' ?>" value="<?= $submenu['nama_submenu']; ?>">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input name="linksubmenu" type="text" class="form-control <?= form_error('linksubmenu') ? 'is-invalid' : '' ?>" value="<?= $submenu['link_submenu']; ?>">
                                    ...
                                    <select name="menuinduk" class="form-select <?= form_error('menuinduk') ? 'is-invalid' : '' ?>">
                                        ...
                                        <?php foreach ($menunav as $menu) : ?>
                                            <option value="<?= $menu['id_menu']; ?>"
                                                <?= $menu['id_menu'] == $submenu['id_menu'] ? 'selected' : '' ?>>
                                                <?= $menu['nama_menu']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>

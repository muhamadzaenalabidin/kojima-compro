    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form ubah Slider</h5>



                        <!-- General Form Elements -->
                        <?= form_open_multipart('slider/editslider/' . $slider['id_slider'], ['class' => 'row g-3']); ?>

                        <div class="col-md-12">
                            <label class="form-label">Text Utama</label>
                            <input name="headline" type="text" class="form-control <?= form_error('headline') ? 'is-invalid' : '' ?>" value="<?= $slider['headline']; ?>">
                            <?= form_error('headline', '<div class="invalid-feedback">', '</div>'); ?>
                        </div>

                        <div class="col-md-12">
                            <label class="form-label">Text Tambahan</label>
                            <input name="desk" type="text" class="form-control <?= form_error('desk') ? 'is-invalid' : '' ?>" value="<?= $slider['desk']; ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="tombol_text1" type="text" class="form-control <?= form_error('tombol_text1') ? 'is-invalid' : '' ?>" value="<?= $slider['tombol_text1']; ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="tombol_text2" type="text" class="form-control <?= form_error('tombol_text2') ? 'is-invalid' : '' ?>" value="<?= $slider['tombol_text2']; ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="tombol_link1" type="text" class="form-control <?= form_error('tombol_link1') ? 'is-invalid' : '' ?>" value="<?= $slider['tombol_link1']; ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="tombol_link2" type="text" class="form-control <?= form_error('tombol_link2') ? 'is-invalid' : '' ?>" value="<?= $slider['tombol_link2']; ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="aktifSwitch" name="aktif" <?= $slider['aktif'] == 'on' ? 'checked' : '' ?>>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input name="image_slide" type="file" class="form-control <?= form_error('image_slide') ? 'is-invalid' : '' ?>" value="<?= $slider['image_slide']; ?>">
